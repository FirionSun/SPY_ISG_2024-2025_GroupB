...
public class DragDropSystemBridge : MonoBehaviour
{
    ...
    public void onlyInteger(string newValue)
    {
        DragDropSystem.instance.onlyInteger(gameObject, newValue);
    }
    public void onlyBoolean(string newValue)
    {
        DragDropSystem.instance.onlyBoolean(gameObject, newValue);
    }
